...
cd "${SHIVA_PROJECT_PATH}/Plugins/${PLUGIN_ID}/Make/tvOS/"
...
#build simulator
xcodebuild -project ${PLUGIN_NAME}.xcodeproj -destination 'platform=tvOS Simulator,name=Apple TV 4K,OS=11.2' -scheme ${PLUGIN_NAME} -configuration Release
...
cd "${SHIVA_PROJECT_PATH}/Plugins/${PLUGIN_ID}/Contents/tvOS/"
